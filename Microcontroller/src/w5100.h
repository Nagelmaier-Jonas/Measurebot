...
void W5100Init(void); // reset iinchip
void W5100SysInit(uint8 tx_size, uint8 rx_size); // setting tx/rx buf size
...
void W5100SetGWIPAddr(uint8 * addr); // set gateway address
void W5100GetGWIPAddr(uint8 * addr);
void W5100SetSubNetMask(uint8 * addr); // set subnet mask address
void W5100ApplySubNetMask(void); // set subnet mask address
void W5100ClearSubAddr(void);
void W5100SetMACAddr(uint8 * addr); // set local MAC address
void W5100GetMACAddr(uint8 * addr);
void W5100SetIPAddr(uint8 * addr); // set local IP address
...
uint8 W5100GetSn_SR(SOCKET s); // get socket status
extern uint16 getSn_TX_FSR(SOCKET s); // get socket TX free buf size
uint16 W5100GetSn_RX_RSR(SOCKET s); // get socket RX recv buf size
